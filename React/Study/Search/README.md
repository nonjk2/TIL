...
<!-- [카카오API](https://developers.kakao.com/docs/latest/ko/daum-search/dev-guide#search-doc) 를 살펴 보면 URL , KEY 단 두개로 여러가지 다양한 유형의 검색어 API를 이용할수 있었다. -->

<!-- 웹 디자인같은경우 저번에 너무 CSS에 너무 많이 시간을 잡아 먹는다고 하셔서
간단한 디자인 3개를 준비해봤다. -->
